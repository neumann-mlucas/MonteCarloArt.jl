...
CSV_HEADER="image,config,steps,palette,tol,threads,stop_miss,seconds,circles,stopped_at,status,git_sha"

# name|steps|palette|tol|threads|stop_miss
CONFIGS=(
  "fast_threaded|100000|64|0.08|8|1.0"
  "fast_stop_only|100000|64|0.08|1|0.95"
  "fast_threaded_stop|100000|64|0.08|8|0.95"
  "full_threaded_stop|300000|64|0.08|8|0.95"
)
...
run_config() {
  ...
  IFS='|' read -r name steps palette tol threads stop_miss <<< "$cfg"
  ...
  echo "${img},${name},${steps},${palette},${tol},${threads},${stop_miss},${LAST_SECS},${circles:-},${stopped:-},${LAST_STATUS},$(git_sha)" >> "$BENCH_CSV"
